...
#' @descripton Convert in-air FOV angle to in-water FOV angle based on refractive index of water
...
#' @descripton Calucate the coordinate of the camera nadir (point directly below the camera) in pixel coordinates of the image
...
#' @descripton Calculate the camera constant C based on camera sensor dimensions
...
#' @descripton Calculate height of an annotation in a low oblique image where camera specifics such as FOV, height & angle are known
...
#' Calculate height of annotation in image
#' @descripton Calculate height of an annotation in an image where camera specifics such as FOV, height & angle are known
#' @param X1 x pixel coordinate of base of annotation object
#' @param Y1 y pixel coordinate of base of annotation object
#' @param X2 x pixel coordinate of top of annotation object
#' @param Y1 y pixel coordinate of top of annotation object
